...
from deepstack.utils.constants import (
    ACTIONS as ACTION_IDS,
    ACPC_ACTIONS as ACPC_ACTION_IDS,
    NODE_TYPES as NODE_TYPE_IDS,
    PLAYERS as PLAYER_IDS,
    PLAYERS_COUNT,
    STREETS_COUNT,
)

# Public mappings maintained for backward compatibility
PLAYERS = {'chance': PLAYER_IDS.CHANCE, 'P1': PLAYER_IDS.P1, 'P2': PLAYER_IDS.P2}
NODE_TYPES = {
    'terminal_fold': NODE_TYPE_IDS.TERMINAL_FOLD,
    'terminal_call': NODE_TYPE_IDS.TERMINAL_CALL,
    'chance_node': NODE_TYPE_IDS.CHANCE_NODE,
    'inner_node': NODE_TYPE_IDS.INNER_NODE,
}
ACTIONS = {'fold': ACTION_IDS.FOLD, 'ccall': ACTION_IDS.CCALL, 'raise': ACTION_IDS.RAISE}
ACPC_ACTIONS = {
    'fold': ACPC_ACTION_IDS.FOLD,
    'ccall': ACPC_ACTION_IDS.CCALL,
    'raise': ACPC_ACTION_IDS.RAISE,
}
