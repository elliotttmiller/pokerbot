...
class DeepStackTrainer:
    def __init__(self, num_buckets, data_path, batch_size=32, hidden_sizes=[128,128], use_gpu=False, lr=0.001, epochs=10):
        self.net = NetBuilder.build_net(num_buckets, hidden_sizes, use_gpu)
    ...
    def train(self):
        for epoch in range(self.epochs):
            ...
            # Optionally save model and validation loss
