...
class NetBuilder(nn.Module):
    def __init__(self, num_buckets, hidden_sizes=[128, 128], use_gpu=False):
        super().__init__()
    ...
    @staticmethod
    def build_net(num_buckets, hidden_sizes=[128, 128], use_gpu=False):
        return NetBuilder(num_buckets, hidden_sizes, use_gpu)
